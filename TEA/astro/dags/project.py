...
def model_training(**context):
    ...
    file_path_model = os.path.join(path, 'myModel.pkl')
    try:
...
get_files_directory_task >> load_and_merge_dataset_task >> api_merged_and_clean_task >> model_training_task
...
# def load_model():
#     model_path = get_files_directory()+'/myModel.pkl'
